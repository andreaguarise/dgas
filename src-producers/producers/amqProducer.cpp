...
// Client APIs.
// 
// $Id: amqProducer.cpp,v 1.1.2.11.2.6 2012/11/09 10:17:02 aguarise Exp $
// -------------------------------------------------------------------------
...
endl;
	...
	bool persistentDelivery = false;
	if ( (parms.persistentDelivery == "true" ) || ( parms.persistentDelivery == "yes") )  persistentDelivery = true;

	std::string username = parms.amqUsername;
	std::string password = parms.amqPassword;
	unsigned int numMessages = 1;
	
	SimpleProducer producer( brokerURI, numMessages, destURI, useTopics, clientAck, persistentDelivery, username, password );
