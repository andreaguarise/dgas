...
// 
// $Id: hlrQtransMgrd.cpp,v 1.1.2.1.4.13.2.3 2012/03/16 15:07:50 aguarise Exp $
// -------------------------------------------------------------------------
...
/*no pricing. requires architecture revision. Sorry.
...
int processErrorTransactions(int i)
{
	...
	time_t currtime;
	currtime = time(NULL);
	string fileName = "/var/spool/dgas/hlr_tmp_dump-";
